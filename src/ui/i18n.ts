...
const en: Record<DictKey, string> = {
  ...
  'form.varHint': 'Reference variables in the body with {{variable}}',
  ...
  'form.keepOneVar': 'Keep at least one variable placeholder',
